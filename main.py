...
if __name__ == "__main__":
    ...
    train_folder = "CHROMOSOME_INSTABILITY_hg38/test" 
    ...
    if train_patients_df.empty:
        ...
        iso_forest = IsolationForest(n_estimators=1000, contamination=0.33, random_state=42, n_jobs=-1)
        
        # Patient_ID is the index: fit, predict and decision_function exclude it 
        iso_forest.fit(train_patients_df)
        
        test_folder = "CHROMOSOME_INSTABILITY_hg38/train"
